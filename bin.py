...
file_path_lstm = r"C:\Users\manii\OneDrive\Desktop\Project Phase 1\Dataset\coin_BinanceCoin.csv"
file_path_prophet = r"C:\Users\manii\OneDrive\Desktop\Project Phase 1\Dataset\coin_BinanceCoin.csv"
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(
            html.Div(
                html.H1("Prophet Analysis of BinanceCoin", className="text-center mx-auto",),
    ...
    dbc.Row([
        dbc.Col(
            html.Div(
                html.H1("LSTM Analysis of BinanceCoin", className="text-center mx-auto",),
                style={'color': '#444444', 'border': '5px solid #444444', 'padding': '5px'}
            ),
            width={"size": 6, "offset": 3}
        ),
    ...
    dbc.Row([
        dbc.Col(
            dbc.Button("Proceed to Dashboard", href="https://app.powerbi.com/groups/me/reports/9aae6b55-0598-4d4d-90a0-0fb61ceea71d/ReportSection509476fcb8cb128b3a4e?experience=power-bi", target="_blank", color="primary", className="mr-2"),
            width=12
        ),
    ]),
    dbc.Row([
