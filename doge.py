...
file_path_lstm = r"C:\Users\manii\OneDrive\Desktop\Project Phase 1\Dataset\coin_Dogecoin.csv"
file_path_prophet = r"C:\Users\manii\OneDrive\Desktop\Project Phase 1\Dataset\coin_Dogecoin.csv"
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(
            html.Div(
                html.H1("Prophet Analysis of DogeCoin", className="text-center mx-auto",),
    ...
    dbc.Row([
        dbc.Col(
            html.Div(
                html.H1("LSTM Analysis of DogeCoin", className="text-center mx-auto",),
                style={'color': '#444444', 'border': '5px solid #444444', 'padding': '5px'}
            ),
            width={"size": 6, "offset": 3}
        ),
    ...
    dbc.Row([
        dbc.Col(
            dbc.Button("Proceed to Dashboard", href="https://app.powerbi.com/groups/me/reports/0c6119d3-3882-41d5-8552-e43bb54c49d7/ReportSection73b2d18b44694e7b3e8a?experience=power-bi", target="_blank", color="primary", className="mr-2"),
            width=12
        ),
    ]),
    dbc.Row([
